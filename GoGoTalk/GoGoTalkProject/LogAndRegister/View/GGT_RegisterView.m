...
- (void)setUpContentView {
    ...
    [backImgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_offset(CGSizeMake(9, 16));
    }];
    ...
    self.registerButton.backgroundColor = UICOLOR_FROM_HEX(ColorCF121C);
    ...
    [label mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.registerButton.mas_bottom).with.offset(margin15);
    ...
    [self.loginButton setTitleColor:UICOLOR_FROM_HEX(ColorEA5851) forState:(UIControlStateNormal)];
    self.loginButton.titleLabel.font = SystemFont(14);
