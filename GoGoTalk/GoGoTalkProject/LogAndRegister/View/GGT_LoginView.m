...
- (void)setUpContentView {
    ...
    self.phonelineView.backgroundColor = UICOLOR_FROM_HEX(0xCCCCCC);
    ...
    self.passwordlineView.backgroundColor = UICOLOR_FROM_HEX(0xCCCCCC);
    ...
    self.loginButton.backgroundColor = UICOLOR_FROM_HEX(0xCF121C);
    ...
    [self.registerButton setTitleColor:UICOLOR_FROM_HEX(0xCF121C) forState:(UIControlStateNormal)];
    self.registerButton.layer.borderWidth = LineW(0.5);
    self.registerButton.layer.borderColor = UICOLOR_FROM_HEX(0xCF121C).CGColor;
...
- (void)textFieldDidBeginEditing:(UITextField *)textField {
    if (textField == self.phoneAccountField) {
        self.phoneAccountView.layer.borderColor = UICOLOR_FROM_HEX(0xCF121C).CGColor;
        self.phoneAccountField.tintColor = UICOLOR_FROM_HEX(0xCF121C);
        self.phoneImageView.image = UIIMAGE_FROM_NAME(@"iphone_login_yi");
        self.phonelineView.backgroundColor = UICOLOR_FROM_HEX(0xCF121C);
    } else {
        self.passwordView.layer.borderColor = UICOLOR_FROM_HEX(0xCF121C).CGColor;
        self.passwordField.tintColor = UICOLOR_FROM_HEX(0xCF121C);
        self.passwordImageView.image = UIIMAGE_FROM_NAME(@"mima_login_yi");
        self.passwordlineView.backgroundColor = UICOLOR_FROM_HEX(0xCF121C);
    }
}
